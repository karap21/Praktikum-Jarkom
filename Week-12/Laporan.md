...
* Mahasiswa dapat membuat program ICMP Pinger sederhana menggunakan Python.
* Melakukan asistensi dan melaporkan progress pengerjaan Tugas Besar.
...
![Output Command Prompt Ping](Gambar/1.png)
...
![Daftar Paket ICMP Ping](Gambar/2.png)

**Detail Paket Echo Request (Tipe 8, Kode 0)**

![Struktur Paket Echo Request](Gambar/3.png)
...
![Struktur Paket Echo Reply](Gambar/4.png)
...
![Output Command Prompt Traceroute](Gambar/5.png)
...
![Paket ICMP Traceroute](Gambar/6.png)

**Detail Paket ICMP Time Exceeded (Tipe 11, Kode 0)**

![Struktur Paket Time Exceeded](Gambar/7.png)
...
| Length | 17 | Length of original datagram: 68 |

*Struktur Tambahan yang Penting:* Paket Time Exceeded berisi salinan header IP asli dari paket yang menyebabkan error:
...
* **TTL = 42 pada Ping:**
  ...
  * Perhitungan: 128 - 42 = 86 hops dari source ke destination. Ini menunjukkan paket melewati sekitar 86 router dari Indonesia ke Hong Kong.
...
* **Traceroute: 2 Timeout Hops (Hop 4 & 5)**
  ...
  * Penyebab:
    * Router dikonfigurasi untuk tidak merespons ICMP (security policy).
    * Firewall memblokir ICMP Time Exceeded messages.
    * Router terlalu sibuk (high CPU utilization).
